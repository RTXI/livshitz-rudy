...
const static double Vcell = 1000*pi*radius*radius*length_cell;				// 3.801e-5 uL Cell volume (uL)
const static double Ageo = 2*pi*radius*radius+2*pi*radius*length_cell;		// 7.671e-5 cm^2 Geometric membrane area (cm^2)
...
// const static double Ko = 4.5 ;												// uM
// const static double Nao = 140 ;											    // uM
// const static double Cao = 1.8 ;											    // uM

const static double Ko = 5.4 ; // uM //Changed based on solutions, old was 4.0
const static double Nao = 137; // uM // Changed based on solutions, old was 140
const static double Cao = 2.0 ; // uM // Changed based on solutions, old was 1.8
